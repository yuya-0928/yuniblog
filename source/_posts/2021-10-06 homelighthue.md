...
ただこのライトの色を切り替えるのが面倒くさかったりします。アプリから操作できるので便利ではあるのですが、PC 作業中にスマホを出してアプリを立ち上げ、画面をタップしてライトの色を調整する一連の操作がとても面倒くさく感じてしまいました。また、アプリの立ち上がりも 2 秒ほどかかるので、ストレスフリーというわけでもありません。
PC 作業中にそのままライトを操作したい！　と思って Windows のアプリを探したのですが、自分にとって使い勝手がよさそうなものもありません。
...
のようにライトの明るさやオンオフのステータスなどを put して上げると、そのライトを操作できます。
...
これで、今まで 5 秒以上かかっていた電気の明るさ切り替えが、コマンド 1 つでものの 1 秒で操作できるようになりました！
